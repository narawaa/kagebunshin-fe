...
import { QueryResultRowProps } from './interface';
...
export const QueryPageModule = () => {
  ...
  const [result, setResult] = useState<QueryResultRowProps[] | null>(null);
  ...
  const handleRun = async () => {
    setResult([
      { name: 'Entity A', type: 'Class', label: 'Sample A' },
      { name: 'Entity B', type: 'Property', label: 'Sample B' },
      { name: 'Entity C', type: 'Class', label: 'Sample C' },
    ]);
  };
  ...
  return (
    <div className="w-full min-h-screen px-4 md:px-8 lg:px-16 pb-4 pt-10 space-y-4 bg-white">
